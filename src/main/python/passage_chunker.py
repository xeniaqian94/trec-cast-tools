...
nlp = spacy.load("en_core_web_sm",
                 exclude=["parser", "tagger", "ner", "attribute_ruler", "lemmatizer", "tok2vec"])  # ->senter
...
class SpacyPassageChunker:
    ...
    def create_sanitized_doc(self):
        sanitized_doc = ' '.join(sentence.text for sentence in self.sentences)
